...
def SubModel(input_img, transfer=False):
    # ENCODER
...
sub7 = SubModel(input_img7, transfer=False)
sub1 = SubModel(input_img1, transfer=True)
...
if not os.path.exists('models'):
    os.makedirs('models')
fmodel.save(os.path.join('models','1_transfer.h5'))
